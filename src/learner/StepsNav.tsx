                  ...
                  <li key={s.id} className="relative">
                    ...
                    >
                      ...
                      <span className={cx('min-w-0 flex-1', (s.status === 'upcoming' || s.status === 'locked') && 'opacity-60')}>
                        ...
                        <span className={cx('block truncate text-[12.5px] leading-snug', s.status === 'current' ? 'font-bold text-ink' : s.status === 'done' ? 'text-ink-soft line-through decoration-ngreen/50' : 'text-ink-soft')}>{s.title}</span>
                      </span>
                    </button>
                  </li>
                );
