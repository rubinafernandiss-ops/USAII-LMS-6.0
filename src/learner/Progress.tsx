...
/** Study habits and participation. These track engagement only; they never change Comprehension or Mastery. */
function MetricsCard({ item }: { item: CourseItem }) {
  ...
  return (
    <Card className="!p-0 overflow-hidden">
      <h3 className="px-5 pt-5 text-lg font-bold">Your study habits</h3>
...
export default function Progress() {
  ...
  return (
    <div className="space-y-6">
      ...
      <LearningMetrics metrics={active.snapshot.metrics} />
