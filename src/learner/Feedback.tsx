...
function RatingCard({
  ...
  /** Shows the "would you recommend USAII®?" question under the comment box. */
  ...
  const send = async () => {
    ...
    if (askRecommend && recommend === null) return toast('error', 'Please answer whether you would recommend USAII®.');
    setBusy(true);
    try {
    ...
    <Card className="relative overflow-hidden">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="min-w-[240px] flex-1">
          <h2 className="font-display text-lg font-bold">Would you recommend USAII® to others?</h2>
