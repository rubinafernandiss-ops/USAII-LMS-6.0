  ...
  const sections = [
    ...
    <Collapse key="how" title="How to read this page">
      <ul className="space-y-1.5">
        <li>
          <b className="text-ink">Comprehension</b> shows how well you understand the concepts. <b className="text-ink">Mastery</b> shows how well you can apply them in a practical work situation. Both appear after your first two scored checkpoints.
        </li>
        <li>
          <b className="text-ink">Course completed</b> counts finished lessons. It is separate on purpose: finishing a lesson is not the same as understanding it.
        </li>
        <li>
